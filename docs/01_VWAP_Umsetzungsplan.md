...
**Dokumentversion:** 1.1 - Benutzerfreigaben fuer Anker und Swing  
**Stand der Dokumentationspruefung:** 18. September 2026  
**Zielplattform:** TradingView, Pine Script v6, Overlay im Hauptchart  
**Arbeitstitel:** `VWAP Suite - UTC + ATH/ATL + Swing`  
**Status:** Fachliche Hauptspezifikation. Abschnitt 3-Defaults zu ATH/ATL-Anker und Swing-Anzahl sind durch V1.1 ersetzt.

### V1.1 verbindliche Abweichungen von den Plan-Defaults

- ATH/ATL-Anker: tatsaechliche Extremkerze im Berechnungs-Timeframe, nicht 00:00 UTC des Ereignistages. `eventTime = anchorTime`.
- ATH/ATL-Basis: strikt festes Intraday-Intervall (Default 1 Minute, HLC3). Kein stiller 1D-Fallback, kein Hybrid.
- Swing: zwei Linien gleichzeitig (bestaetigtes High und Low). Ein Inputs-Schalter steuert beide.
- Swing-Anker bleibt 00:00 UTC am Pivottag; Pivot 1H, 3 links / 3 rechts.
- Details: `docs/OPEN_DECISIONS.md`.

Der Rest dieses Dokuments (urspruenglich 1.0) bleibt die fachliche Beschreibung, soweit V1.1 ihn nicht ersetzt.
